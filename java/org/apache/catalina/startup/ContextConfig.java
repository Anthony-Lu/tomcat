...
public class ContextConfig implements LifecycleListener {
    ...
    // 从web.xml读取war应用配置信息到WebXml的对象中，
    // 再将配置信息设置到context对象中去
    private void configureContext(WebXml webxml) {
        ...
        // 根据web.xml的配置注册Servlet到容器（context）中，
        // 将来改造eagle平台，核心的SpringDispatchServletZjrcu就是在这里配置的
